    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Création d'une manifestation</div>

                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('create_event') }}">
                        {{ csrf_field() }}

                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            <label for="name" class="col-md-4 control-label">Nom de la manifestation</label>
                        ...
                        <div class="form-group{{ $errors->has('categorie') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <select id="categorie" type="categorie" class="form-control" name="categorie" value="{{ old('categorie') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('date') ? ' has-error' : '' }}">
                            <label for="date" class="col-md-4 control-label">Date de début</label>
                        ...
                        <div class="form-group{{ $errors->has('date_end') ? ' has-error' : '' }}">
                            <label for="date_end" class="col-md-4 control-label">Date de fin</label>

                            <div class="col-md-6">
                                <input id="date_end" type="date" class="form-control" name="date_end" required>

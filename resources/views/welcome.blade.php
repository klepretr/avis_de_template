...
<html lang="{{ app()->getLocale() }}">
    ...
    <body>
        <header class="masthead">
          ...
          <div>
              <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="{{ route('index_trafic') }}"><i class="fa fa-location-arrow" aria-hidden="true"></i><div>Situer</div></a>
          </div>
